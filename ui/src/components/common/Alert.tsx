...
const bgClasses = {
  info: "bg-primary-800 dark:bg-primary-50/50",
  danger: "bg-red-200/50 dark:bg-red-800/10",
  success: "bg-emerald-200/50 dark:bg-emerald-800/10",
};

const iconContainerClasses = {
  info: "bg-primary-600 dark:bg-primary-100",
  danger: "bg-red-400 dark:bg-red-900",
  success: "bg-emerald-300 dark:bg-emerald-900 ",
};
const icons = {
  info: <Info className="h-7 w-8 fill-primary-800 dark:fill-primary-500 stroke-primary-600 dark:stroke-primary-100" />,
  danger: <CircleAlert className="h-7 w-8 fill-red-300 stroke-current dark:stroke-red-900" />,
  success: <BadgeCheck className="h-7 w-8 fill-emerald-300 stroke-current dark:stroke-emerald-900" />,
};
